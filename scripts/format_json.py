...
def formatear_datos(raw_data):
    ...
    prompt = """
Convierte el siguiente currículum al formato JSON DICCIONARIO DE DATOS. Los único campos obligatorios son "Nombre", "Contacto" (si hay más de un contacto que sea lista) y "Titulo" (encuentra su titulo). El resto de la información enfrascala en 4 Secciones 
