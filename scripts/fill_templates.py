...
def fill_templates(json_data):
    ...
    output_html1_path = os.path.join(output_dir, 'plantilla1.html')
    with open(output_html1_path, 'w', encoding='utf-8') as f:
        f.write(rendered_html1)

    output_pdf1_path = os.path.join(output_dir, 'plantilla1.pdf')
    generate_pdf_weasyprint(rendered_html1, output_pdf1_path, css_path_absoluto)
    ...
    output_html2_path = os.path.join(output_dir, 'plantilla2.html')
    with open(output_html2_path, 'w', encoding='utf-8') as f:
        f.write(rendered_html2)

    output_pdf2_path = os.path.join(output_dir, 'plantilla2.pdf')
    generate_pdf_weasyprint(rendered_html2, output_pdf2_path, css_path_absoluto1)
